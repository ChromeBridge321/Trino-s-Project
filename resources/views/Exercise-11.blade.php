        ...
        <div class="maincontainer">
            <div class=" container  border border-2 border-top-0">
                <div class=" col-12 text-center pt-3 pb-3">
                    <h2>Balancea la siguiente ecuacion 11</h2>
                </div>
                <div class=" row">
                    @if (($Rmolecula_1 == 1) & ($Rmolecula_2 == 2) & ($Rmolecula_3 == 1) & ($Rmolecula_4 == 2)){{-- aqui se comparan las variables devueltas
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        ...
                        @if ($molecula_3 <= 0)
                            @php
                                $molecula_3 = 1;
                            @endphp
                            <img class=" img-fluid" src="{{ asset('images/Yodo2.png') }}" alt="">
                        @elseif ($molecula_3 > 3)
                            @php
                                $molecula_3 = 3;
                            @endphp
                        ...
                        @else
                            @for ($i = 0; $i < $molecula_3; $i++)
                                <img class=" img-fluid" src="{{ asset('images/Yodo2.png') }}"
                                    alt="">
                            @endfor
                        @endif
                ...
                <form action="{{ route('exercise-require-1') }}" method="POST" class="row mt-5 pb-4">
                    ...
                    <input class=" d-none" type="text" name="vista" id="" value="Exercise-11">{{--este valor es utilizado para
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center p-0">
                        <h2>Cl<small class=" fs-5">2</small> +</h2> {{--molecula 1--}}
                    </div>
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center p-0">
                        <h2>I<small class=" fs-5">2</small> +</h2>{{--molecula 3--}}
                    </div>
                    ...
                    <div class="col-2 d-flex justify-content-center">
                        <form action="{{ route('index') }}" method="GET">
                            ...
                            <input class=" d-none" type="text" name="vista" id=""
                                value="Exercise-10">{{-- este valor es utilizado para
                                            mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                            de los controladores" --}}
                        </form>
                    </div>
                    <div class="col-2 d-flex justify-content-center">
                        <form action="{{ route('index') }}" method="GET">
                            ...
                            <button class=" btn btn-primary">Siguiente</button>{{-- Este boton llama a la funcion index para limpiar los valores
                                de cada input --}}
                            <input class=" d-none" type="text" name="vista" id=""
                                value="Exercise-12">{{-- este valor es utilizado para
                                            mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                            de los controladores" --}}
                        </form>
                    </div>
                    ...
                    <div class=" col-2 d-flex justify-content-center">
                        <form action="{{ route('exercise-require-1') }}" method="post">
                            ...
                            <input class=" d-none" type="text" name="vista" id="" value="Exercise-11">{{--este valor es utilizado para
                                mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                de los controladores"--}}
                            <input class=" d-none" type="number" name="molecula_2" value="2">{{-- vallor de la molecula 2 --}}
                            <input class=" d-none" type="number" name="molecula_3" value="1">{{-- vallor de la molecula 3 --}}
                            <input class=" d-none" type="number" name="molecula_4" value="2">{{-- vallor de la molecula 4 --}}
