        ...
        <div class="maincontainer">
            <div class=" container  border border-2 border-top-0">
                <div class=" col-12 text-center pt-3 pb-3">
                    <h2>Balancea la siguiente ecuacion 9</h2>
                </div>
                <div class=" row">
                    @if (($Rmolecula_1 == 2) & ($Rmolecula_2 == 2) & ($Rmolecula_3 == 3)) {{-- aqui se comparan las variables devueltas
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        @if ($molecula_1 <= 0)
                            @php
                                $molecula_1 = 1;
                            @endphp
                            <img class=" img-fluid" src="{{ asset('images/Clorato de Potasio.png') }}" alt="">
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        ...
                        @if ($molecula_2 <= 0)
                            @php
                                $molecula_2 = 1;
                            @endphp
                            <img class="img-fluid" src="{{ asset('images/Cloruro de Potasio.png') }}" alt="">
                        @elseif ($molecula_2 > 5)
                            @php
                                $molecula_2 = 5;
                            @endphp
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        ...
                        @else
                            @for ($i = 0; $i < $molecula_3; $i++)
                                <img class=" img-fluid" src="{{ asset('images/Oxígeno2.png') }}"
                                    alt="">
                            @endfor
                        @endif
                ...
                <form action="{{ route('exercise-require-1') }}" method="POST" class="row mt-5 pb-4">
                    ...
                    <input class=" d-none" type="text" name="vista" id="" value="Exercise-9">{{--este valor es utilizado para
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center p-0">
                        <h2>KClO<small class=" fs-5">3</small></h2> {{--molecula 1--}}
                    </div>
