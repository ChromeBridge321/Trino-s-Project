        ...
        <div class="maincontainer">
            <div class=" container  border border-2 border-top-0">
                <div class=" col-12 text-center pt-3 pb-3">
                    <h2>Balancea la siguiente ecuacion 6</h2>
                </div>
                <div class=" row">
                    @if (($Rmolecula_1 == 1) & ($Rmolecula_2 == 3) & ($Rmolecula_3 == 2)) {{-- aqui se comparan las variables devueltas
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        ...
                        @if ($molecula_2 <= 0)
                            @php
                                $molecula_2 = 1;
                            @endphp
                            <img class="img-fluid w-75" src="{{ asset('images/Agua.png') }}" alt="">
                        @elseif ($molecula_2 > 5)
                            @php
                                $molecula_2 = 5;
                            @endphp
                ...
                <form action="{{ route('exercise-require-1') }}" method="POST" class="row mt-5 pb-4">
                    ...
                    <input class=" d-none" type="text" name="vista" id="" value="Exercise-6">{{--este valor es utilizado para
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center p-0">
                        <h2>P<small class=" fs-5">2</small>O<small class=" fs-5">5</small> +</h2> {{--molecula 1--}}
                    </div>
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center">
                        <h2>H<small class=" fs-5">2</small>O</h2> {{--molecula 2--}}
                    </div>
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center p-0">
                        <h2>H<small class=" fs-5">3</small>PO<small class=" fs-5">4</small></h2>{{--molecula 3--}}
                    </div>
                    ...
                    <div class="col-2 d-flex justify-content-center">
                        <form action="{{ route('index') }}" method="GET">
                            ...
                            <button class=" btn btn-primary">Siguiente</button>{{-- Este boton llama a la funcion index para limpiar los valores
                                de cada input --}}
                            <input class=" d-none" type="text" name="vista" id=""
                                value="Exercise-7">{{-- este valor es utilizado para
                                            mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                            de los controladores" --}}
                        </form>
                    </div>
