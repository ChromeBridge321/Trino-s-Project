        ...
        <div class="maincontainer">
            <div class=" container  border border-2 border-top-0">
                <div class=" col-12 text-center pt-3 pb-3">
                    <h2>Balancea la siguiente ecuacion 4</h2>
                </div>
                <div class=" row">
                    @if (($Rmolecula_1 == 4) & ($Rmolecula_2 == 3) & ($Rmolecula_3 == 2)) {{-- aqui se comparan las variables devueltas
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        @if ($molecula_1 <= 0)
                            @php
                                $molecula_1 = 1;
                            @endphp
                            <img class=" img-fluid w-50" src="{{ asset('images/Aluminio.png') }}" alt="">
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        ...
                        @if ($molecula_2 <= 0)
                            @php
                                $molecula_2 = 1;
                            @endphp
                            <img class="img-fluid w-75" src="{{ asset('images/Oxigeno2.png') }}" alt="">
                        @elseif ($molecula_2 > 4)
                            @php
                                $molecula_2 = 4;
                            @endphp
                    ...
                    <div class="col d-flex justify-content-center align-items-center flex-column">
                        ...
                        @if ($molecula_3 <= 0)
                            @php
                                $molecula_3 = 1;
                            @endphp
                            <img class=" img-fluid" src="{{ asset('images/OxidodeAluminio.png') }}" alt="">
                        @elseif ($molecula_3 > 3)
                            @php
                                $molecula_3 = 3;
                            @endphp
                        ...
                        @else
                            @for ($i = 0; $i < $molecula_3; $i++)
                                <img class=" img-fluid" src="{{ asset('images/OxidodeAluminio.png') }}"
                                    alt="">
                            @endfor
                        @endif
                ...
                <form action="{{ route('exercise-require-1') }}" method="POST" class="row mt-5 pb-4">
                    ...
                    <input class=" d-none" type="text" name="vista" id="" value="Exercise-4">{{--este valor es utilizado para
                    ...
                    <div class="d-flex justify-content-center align-items-center col text-center p-0">
                        <h2>Al<small class=" fs-5">2</small>O<small class=" fs-5">3</small></h2>{{--molecula 3--}}
                    </div>
                ...
                <div class=" row d-flex justify-content-end pb-4">
                    <div class="col-2 d-flex justify-content-center">
                        <form action="{{ route('index') }}" method="GET">
                            ...
                            <input class=" d-none" type="text" name="vista" id=""
                                value="Exercise-3">{{-- este valor es utilizado para
                                            mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                            de los controladores" --}}
                        </form>
                    </div>
                    <div class="col-2 d-flex justify-content-center">
                        <form action="{{ route('index') }}" method="GET">
                            ...
                            <button class=" btn btn-primary">Siguiente</button>{{-- Este boton llama a la funcion index para limpiar los valores
                                de cada input --}}
                            <input class=" d-none" type="text" name="vista" id=""
                                value="Exercise-5">{{-- este valor es utilizado para
                                            mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                            de los controladores" --}}
                        </form>
                    </div>
                    ...
                    <div class=" col-2 d-flex justify-content-center">
                        <form action="{{ route('exercise-require-1') }}" method="post">
                            ...
                            <input class=" d-none" type="number" name="molecula_1" value="4">{{-- valor de la molecula 1 --}}
                            <input class=" d-none" type="text" name="vista" id="" value="Exercise-4">{{--este valor es utilizado para
                                mandar la cadena "Exercise-x esto es para poder redirigir a la vista correcta y solo hacer uso de pocoas funciones por parte
                                de los controladores"--}}
